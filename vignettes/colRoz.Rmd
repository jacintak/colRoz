...
subtitle: "A colour palette from down under"
author: 
 - Jacinta Kong
 - https://jacintak.github.io
...
If a continuous palette is desired, then the function will use the function colorRampPalette in the grDevices package (included in R) to generate a gradient of colours between the first and last colour in the desired palette. In `ggplot2`, use the function `scale_colour_gradient` to set the continuous scale.
